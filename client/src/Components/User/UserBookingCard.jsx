      ...
      >
        ...
        <div className="flex justify-between items-start mb-4">
          <div>
            <h3 className="text-lg font-semibold text-gray-800">
              {booking?.service?.title || booking?.service?.category || "Service"}
            </h3>
          ...
          <span
            className={`flex items-center gap-1 text-sm font-medium px-3 py-1 rounded-full capitalize ${color}`}
          >
            {icon}
            {booking?.status}
          </span>
        ...
        <div className="mt-5 flex justify-end">
          ...
          {booking?.status === "cancelled" && (
            <button className="px-4 py-2 bg-gray-400 hover:bg-gray-500 text-white text-sm rounded-lg transition-all">
              Rebook
            </button>
          )}
          {booking?.status === "expired" && (
            <button className="px-4 py-2 bg-red-500 hover:bg-red-600 text-white text-sm rounded-lg transition-all">
              Delete
            </button>
          )}
        </div>
