  ...
  return (
    <div className='max-w-xl shadow-md shadow-gray-500 mx-auto px-5 py-6 flex flex-col gap-6'>
      ...
      <div className='flex gap-4 justify-end pt-4'>
        ...
        <button onClick={()=>submit()} className='px-6 py-2 text-sm font-semibold bg-green-600 hover:bg-green-700 text-white rounded transition cursor-pointer active:translate-y-0.5'>
          Submit
        </button>
      </div>
    </div>
